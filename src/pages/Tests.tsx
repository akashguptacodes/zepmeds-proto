      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card className="p-6 text-center">
            ...
            <h3 className="font-semibold text-lg mb-2">Home Collection</h3>
            <p className="text-gray-600">Safe sample collection at your doorstep</p>
          </Card>
          <Card className="p-6 text-center">
            <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <Clock className="h-8 w-8 text-green-600" />
            </div>
            <h3 className="font-semibold text-lg mb-2">Fast Reports</h3>
            <p className="text-gray-600">Get reports within 2-24 hours</p>
          </Card>
          <Card className="p-6 text-center">
            ...
            <p className="text-gray-600">Schedule tests at your convenience</p>
          </Card>
        </div>

        {/* Category Filter */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Popular Health Tests</h2>
